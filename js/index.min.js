!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){__webpack_require__(3),__webpack_require__(2)},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
...
void 0===s.cache&&(s.cache=!1),s.crossDomain&&(s.type="GET")}),jQuery.ajaxTransport("script",function(s){if(s.crossDomain){var script,callback;return{send:function(_,complete){script=jQuery("<script>").prop({charset:s.scriptCharset,src:s.url}).on("load error",callback=function(evt){script.remove(),callback=null,evt&&complete("error"===evt.type?404:200,evt.type)}),document.head.appendChild(script[0])},abort:function(){callback&&callback()}}}});var oldCallbacks=[],rjsonp=/(=)\?(?=&|$)|\?\?/;jQuery.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var callback=oldCallbacks.pop()||jQuery.expando+"_"+nonce++;return this[callback]=!0,callback}}),jQuery.ajaxPrefilter("json jsonp",function(s,originalSettings,jqXHR){var callbackName,overwritten,responseContainer,jsonProp=s.jsonp!==!1&&(rjsonp.test(s.url)?"url":"string"==typeof s.data&&0===(s.contentType||"").indexOf("application/x-www-form-urlencoded")&&rjsonp.test(s.data)&&"data");return jsonProp||"jsonp"===s.dataTypes[0]?(callbackName=s.jsonpCallback=jQuery.isFunction(s.jsonpCallback)?s.jsonpCallback():s.jsonpCallback,jsonProp?s[jsonProp]=s[jsonProp].replace(rjsonp,"$1"+callbackName):s.jsonp!==!1&&(s.url+=(rquery.test(s.url)?"&":"?")+s.jsonp+"="+callbackName),s.converters["script json"]=function(){return responseContainer||jQuery.error(callbackName+" was not called"),responseContainer[0]},s.dataTypes[0]="json",overwritten=window[callbackName],window[callbackName]=function(){responseContainer=arguments},jqXHR.always(function(){void 0===overwritten?jQuery(window).removeProp(callbackName):window[callbackName]=overwritten,s[callbackName]&&(s.jsonpCallback=originalSettings.jsonpCallback,oldCallbacks.push(callbackName)),responseContainer&&jQuery.isFunction(overwritten)&&overwritten(responseContainer[0]),responseContainer=overwritten=void 0}),"script"):void 0}),support.createHTMLDocument=function(){var body=document.implementation.createHTMLDocument("").body;return body.innerHTML="<form></form><form></form>",2===body.childNodes.length}(),jQuery.parseHTML=function(data,context,keepScripts){if(!data||"string"!=typeof data)return null;"boolean"==typeof context&&(keepScripts=context,context=!1),context=context||(support.createHTMLDocument?document.implementation.createHTMLDocument(""):document);var parsed=rsingleTag.exec(data),scripts=!keepScripts&&[];return parsed?[context.createElement(parsed[1])]:(parsed=buildFragment([data],context,scripts),scripts&&scripts.length&&jQuery(scripts).remove(),jQuery.merge([],parsed.childNodes))};var _load=jQuery.fn.load;jQuery.fn.load=function(url,params,callback){if("string"!=typeof url&&_load)return _load.apply(this,arguments);var selector,type,response,self=this,off=url.indexOf(" ");return off>-1&&(selector=jQuery.trim(url.slice(off)),url=url.slice(0,off)),jQuery.isFunction(params)?(callback=params,params=void 0):params&&"object"==typeof params&&(type="POST"),self.length>0&&jQuery.ajax({url:url,type:type||"GET",dataType:"html",data:params}).done(function(responseText){response=arguments,self.html(selector?jQuery("<div>").append(jQuery.parseHTML(responseText)).find(selector):responseText)}).always(callback&&function(jqXHR,status){self.each(function(){callback.apply(self,response||[jqXHR.responseText,status,jqXHR])})}),this},jQuery.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(i,type){jQuery.fn[type]=function(fn){return this.on(type,fn)}}),jQuery.expr.filters.animated=function(elem){return jQuery.grep(jQuery.timers,function(fn){return elem===fn.elem}).length},jQuery.offset={setOffset:function(elem,options,i){var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,jQuery.extend({},curOffset))),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,elem=this[0],box={top:0,left:0},doc=elem&&elem.ownerDocument;if(doc)return docElem=doc.documentElement,jQuery.contains(docElem,elem)?(box=elem.getBoundingClientRect(),win=getWindow(doc),{top:box.top+win.pageYOffset-docElem.clientTop,left:box.left+win.pageXOffset-docElem.clientLeft}):box},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset.top+=jQuery.css(offsetParent[0],"borderTopWidth",!0),parentOffset.left+=jQuery.css(offsetParent[0],"borderLeftWidth",!0)),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){return computed?(computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed):void 0})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable,null)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)},size:function(){return this.length}}),jQuery.fn.andSelf=jQuery.fn.addBack,__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return jQuery}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),!(void 0!==__WEBPACK_AMD_DEFINE_RESULT__&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery})},function(module,exports,__webpack_require__){var $=__webpack_require__(1);(function(){function startPomodoro(){$pour.removeClass("hidden"),$fill.removeClass("hidden"),workTime=parseInt($workTime.html()),$fill.css("webkit-animation-duration",60*workTime+"s");var heading=$pomodoroAnimation.find("div.pour").clone().removeClass();$pomodoroAnimation.find("div.pour").remove(),$pomodoroAnimation.find("div.banner").append(heading),heading.addClass("pour");var heading=$pomodoroAnimation.find("div.fill").clone().removeClass();$pomodoroAnimation.find("div.fill").remove(),$pomodoroAnimation.find("div.banner").append(heading),heading.addClass("fill"),$fill=$pomodoroAnimation.find(".fill"),$fill.css("webkit-transform","translateY(150px)"),$fill.css("webkit-animation-name","fillAction"),$fill.one("webkitAnimationEnd oanimationend oanimationEnd msAnimationEnd",function(e){breakTime=parseInt($breakTime.html()),startBreakTime(breakTime)}),$startButton.addClass("hidden"),$stopButton.removeClass("hidden"),$pauseOrContinueButton.removeClass("hidden")}function startBreakTime(breakTime){var heading=$pomodoroAnimation.find("div.pour").clone().removeClass();$pomodoroAnimation.find("div.pour").remove(),$pomodoroAnimation.find("div.banner").append(heading),heading.addClass("pour"),heading.addClass("hidden");var heading=$pomodoroAnimation.find("div.fill").clone().removeClass();$pomodoroAnimation.find("div.fill").remove(),$pomodoroAnimation.find("div.banner").append(heading),heading.addClass("fill"),$fill=$pomodoroAnimation.find(".fill"),$fill.css("webkit-transform","translateY(-5px)"),$fill.css("webkit-animation-duration",60*breakTime+"s"),$fill.css("webkit-animation-name","emptyAction"),$fill.one("webkitAnimationEnd oanimationend oanimationEnd msAnimationEnd",function(e){$startButton.removeClass("hidden"),$pauseOrContinueButton.addClass("hidden"),$stopButton.addClass("hidden")})}function stopPomodoro(){$pour=$pomodoroAnimation.find(".pour"),$pour.addClass("hidden"),$fill.addClass("hidden"),$stopButton.addClass("hidden"),$pauseOrContinueButton.addClass("hidden"),$startButton.removeClass("hidden")}function pauseOrContinuePomodoro(){$waveShape=$pomodoroAnimation.find("#waveShape"),1==paused?(paused=!1,$pauseOrContinueButton.html("Pause"),$fill.css("webkit-animation-play-state","running"),$waveShape.css("webkit-animation-play-state","running")):(paused=!0,$pauseOrContinueButton.html("Continue"),$fill.css("webkit-animation-play-state","paused"),$waveShape.css("webkit-animation-play-state","paused"))}var paused=!1,$pomodoroAnimation=$(".pomodoro-animation"),$pour=$pomodoroAnimation.find(".pour"),$fill=$pomodoroAnimation.find(".fill"),$waveShape=$pomodoroAnimation.find("#waveShape"),$buttons=$(".buttons"),$startButton=$buttons.find(".start-button"),$stopButton=$buttons.find(".stop-button"),$pauseOrContinueButton=$buttons.find(".pause-button"),$breakTime=$(".break-length-value"),$workTime=$(".work-length-value");$startButton.on("click",null,startPomodoro),$stopButton.on("click",null,stopPomodoro),$pauseOrContinueButton.on("click",null,pauseOrContinuePomodoro)})()},function(module,exports,__webpack_require__){var $=__webpack_require__(1),times=function(){function changeTime(event){var timeType=event.data.timeType,plusOrMinus=event.data.plusOrMinus;if("work"==timeType){var workTimeValue=parseInt($workTime.html());0==workTimeValue&&"-"==plusOrMinus||$workTime.html(eval($workTime.html()+plusOrMinus+"1").toString())}else{var breakTimeValue=parseInt($breakTime.html());0==breakTimeValue&&"-"==plusOrMinus||$breakTime.html(eval($breakTime.html()+plusOrMinus+"1").toString())}}var $timeSection=$(".time-lengths"),$breakMinusButton=$timeSection.find(".break-minus-button"),$breakPlusButton=$timeSection.find(".break-plus-button"),$breakTime=$timeSection.find(".break-length-value"),$workMinusButton=$timeSection.find(".work-minus-button"),$workPlusButton=$timeSection.find(".work-plus-button"),$workTime=$timeSection.find(".work-length-value");$breakMinusButton.on("click",{timeType:"break",plusOrMinus:"-"},changeTime),$breakPlusButton.on("click",{timeType:"break",plusOrMinus:"+"},changeTime),$workMinusButton.on("click",{timeType:"work",plusOrMinus:"-"},changeTime),$workPlusButton.on("click",{timeType:"work",plusOrMinus:"+"},changeTime)}()}]);